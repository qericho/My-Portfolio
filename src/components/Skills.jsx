...
const Skills = () => {
  return (
    <div className="w-full h-full bg-[#1a324c]" id="skills">
        ...
        <div className="container mx-auto md:px-0 px-2">
          ...
          whileInView="show"
          viewport={{ once: true }}
           className="max-h-full w-[100%] mx-auto grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 place-items-center
           my-10 md:my-20 text-5xl md:text6xl lg:text-7xl text-[#8cb0d9] gap-y-5 md:gap-y-10 px-0 md:px-5">
       ...
       <svg className="relative bottom-[-1px]"
