        ...
        <div className="container mx-auto h-full py-8 px-5 md:px-2">
            ...
            <motion.div
             ...
             className="w-[100%] md:w-[80%] mx-auto text-[#cfd8e2] mt-[30px] md:mt-[100px] relative">
                ...
                <h1 className="my-5 md:my-10 text-[#8cb0d9] text-4xl md:text-5xl">Hello, I'm Echo🙂</h1>
                <p className="my-4 text-2xl max-w-[100%] md:max-w-[90%]">I believe a well-designed interface can improve user experiences. It can completely change how people interact with technology.</p>
                ...
                <motion.div
                 ...
                 className="w-full text-center mt-15">
                    <RouterLink><ViewAllButton title={'More About Me'}/></RouterLink>
                </motion.div>
        </div>
    </div>
  )
