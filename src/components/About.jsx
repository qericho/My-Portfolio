        ...
        <div className="h-full w-full" id="about">
            <div className="container mx-auto h-full py-8 px-5 md:px-2">
                ...
                <motion.div
                    ...
                    <p className="my-4 text-2xl max-w-[100%] md:max-w-[90%]">I'm a fresh graduate from Laguna University, and I believe a well-designed interface can improve user experiences. </p>
